<div class="col">
    <!-- Modal -->
    <div class="modal fade" id="AddHangarModal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="AddItemModalLabel">{{__('general_words.hangar')}}</h5>
                ...
                <div class="modal-body row p-5">                  
                    ...
                    <div class="col-md-12">
                        <div class="row mb-4">
                            <div class="form-floating">
                        <label for="remark"
                            class="label">{{ __('general_words.description')}}
                            :*</label>
                            <textarea class="form-control no-hieght" required
                            :disabled="disable" v-model="form.description"
                            rows="4"></textarea>
                        </div>
                        </div>
                    </div>
