<div class="col">
    <!-- Modal -->
    <div class="modal fade" id="AddMeasureModal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="AddItemModalLabel">{{__('general_words.unit_of_measure')}}</h5>
                ...
                <div class="modal-body row p-5">
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="form-floating">
                            ...
                            id="fecen9_number" class="form-control">                        
                        </div>
                    </div>
                    <div class="col-md-4 mb-3">
                        <div class="form-floating">
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="form-floating">
                            ...
                            id="name_prs" class="form-control"> 
                        </div>
                    </div>
