                ...
                <div class="card radius-10">
                    <div class="card-title d-flex justify-content-between">
                        <div class="d-flex align-items-center mb-0">
                            ...
                            <h5 class="mb-0 fc-title">{{ __('general_words.heiat_tashriah') }}</h5>
                        </div>
                            <div class="mt-2">
                            <div class="blink ms-4">
                                    <i v-show="disable" class="fadeIn animated bx bx-arrow-back arrow1"></i>
                                    <btn :label="'@lang('settings.add_heiat')'" @click="openModal"
                    ...
                    <div class="card-body card-body1 p-4">
                        ...
                        @include('settings.heiat.create-edit-modal')
                    </div>
                </div>
            </div>
        </div>
            ...
            data() {
                return {
                    ...
                    columns: [
                        ...
                        {
                            label: "@lang('general_words.start_date')",
                            name: 'last_name',
                        },
                        {
                            label: "@lang('general_words.end_date')",
                            name: 'last_name',
                        },
                        {
            ...
            methods: {
                ...
                editRecord(id = null, index) {
                   ...
                   this.selected_employee = this.employees.find((e) => e.id == this.employee_id);
                    axios.get(`{!!url('setting/heiat')!!}/${id}`).then((res) => {
                        let data = res.data;
