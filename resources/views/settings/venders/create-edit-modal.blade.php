<div class="col">
    <!-- Modal -->
    <div class="modal fade" id="AddVenderModal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="AddItemModalLabel">{{__('general_words.donor')}}</h5>
                ...
                <div class="modal-body row p-5">
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="form-floating">
                            <label class="label">{{__('settings.bank_account')}}</label>
                            <input :disabled="disable" v-model="form.bank_account"  
                            class="form-control"> 
                        </div>
                    </div>
