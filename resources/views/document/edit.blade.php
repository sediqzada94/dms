        ...
        var vm = new Vue({
            ...
            methods: {
                editTracker() {
                   ...
                   const td = this.trackers.map((tracker) => {
                    const { 
                       doc_type:{ name:doc_type_name },
                       deadline: { days:deadline },
                       deadline_type: { name:deadline_type_name }, 
                       followup_type: { name:followup_type_name }, 
                       sender: { name:sender_name },
                       receiver: { name:receiver_name },
                       security_level: { name:security_level_name }, 
                ...
                saveForm() {
                        this.loading = true;
                            axios.put(`{{ url('documents/${this.trackerForm.document_id}') }}`, this.form).then((res) => {
